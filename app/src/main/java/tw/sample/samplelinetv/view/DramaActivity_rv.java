...
import tw.sample.samplelinetv.adapter.DramaAdapter_rv;
...
import tw.sample.samplelinetv.element.EmptyRecyclerView;
...
public class DramaActivity_rv extends AppCompatActivity implements SearchView.OnQueryTextListener {
    private SearchView searchView;
    private EmptyRecyclerView emptyRecyclerView;
    private SwipeRefreshLayout swipeRefreshLayout;
    private DramaAdapter_rv dramaAdapter_rv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_drama_rv);
    ...
    private void initView() {
        ...
        dramaAdapter_rv = new DramaAdapter_rv(this, new ArrayList<DramaModel.DramaInfo>());
        emptyRecyclerView.setAdapter(dramaAdapter_rv);
        emptyRecyclerView.setEmptyView(findViewById(R.id.tv_empty));
    }
    ...
    private void getDramaData() {
        ...
        if (!NetworkUtil.isNetworkConnected(DramaActivity_rv.this)) {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    // 抓取 DramaDatabase 資料
                    infos_Drama = DramaDatabase.getInstance(DramaActivity_rv.this).getDramaDao().getAllDramas();
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            dramaAdapter_rv.updateInfo(infos_DramaInfo);
        ...
        OkHttpUtil.doGet(DramaActivity_rv.this, DramaAPI.getUrl_Dramas(), new OkHttpCallBack() {
            @Override
            public void Result(String response) {
                ...
                dramaAdapter_rv.updateInfo(infos_DramaInfo);
                dramaAdapter_rv.setDramaDatabase();
            }
    ...
    public boolean onQueryTextSubmit(String query) {
        dramaAdapter_rv.getFilter().filter(query);
        return false;
    }
    ...
    public boolean onQueryTextChange(String newText) {
        if (TextUtils.isEmpty(newText)) {
            dramaAdapter_rv.getFilter().filter(newText);
        }
        return true;
    }
